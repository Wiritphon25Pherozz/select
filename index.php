...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example m-0 border-0">
    ...
    <form class="row g-3 needs-validation was-validated" novalidate="" method="post" action="insert.php">
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">ชื่อ</label>
        <input type="text" class="form-control" id="validationCustom01"  required="" name="Na">
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="validationCustom02"  required=""  name="La">
      ...
      <div class="col-md-4">
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required="" name="num">
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="validationCustom05" required="" name="pho">
        <div class="invalid-feedback">
          Please provide a valid zip.
        </div>
      </div>
    ...
    <form class="row g-3 needs-validation was-validated" novalidate="" method="post">
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">ชื่อ</label>
        <input type="text" class="form-control" id="validationCustom01"  required=""  name="Na2">
      ...
      <div class="col-md-4">
        <label for="validationCustom02" class="form-label">นามสกุล</label>
        <input type="text" class="form-control" id="validationCustom02"  required="" name="La2">
        <div class="valid-feedback">
          Looks good!
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="input-group has-validation">
          <span class="input-group-text" id="inputGroupPrepend">@</span>
          <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required="" name="num2">
          <div class="invalid-feedback">
            Please choose a username.
          </div>
        </div>
      ...
      <div class="col-md-3">
        <label for="validationCustom05" class="form-label">เบอร์โทร</label>
        <input type="text" class="form-control" id="validationCustom05" required=""  name="pho2">
